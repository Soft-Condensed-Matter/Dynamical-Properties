...
PROGRAM SSCF
 ...
 OPEN(UNIT=13,FILE='TSSCF.dat')             !AUTOCORRELATION STRESS TENSOR
 OPEN(UNIT=14,FILE='KSSCF.dat')             !AUTOCORRELATION KYNETIC STRESS TENSOR
 OPEN(UNIT=15,FILE='PSSCF.dat')             !AUTOCORRELATION POTENTIAL STRESS TENSOR
 OPEN(UNIT=16,FILE='KPSSCF.dat')            !AUTOCORRELATION KYNETIC-POTENTIAL STRESS TENSOR
 REWIND(10)
 REWIND(11)
 REWIND(12)
